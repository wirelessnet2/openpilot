...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate in HONDA_BOSCH:
      ...
      ret.enableCamera = True #Clarity: OpenPilot usually checks to see if the Factory ADAS Camera is connected, but since we disconnected it, we need to force it True. -wirelessnet2
