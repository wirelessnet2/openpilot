...
DAYS_NO_CONNECTIVITY_MAX = 9999999  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 9999999  # send an offroad prompt after 4 days with no internet
...
def handle_fan_uno(max_cpu_temp, bat_temp, fan_speed, ignition):
  new_speed = int(interp(max_cpu_temp, [50.0, 85.0], [0, 100]))
