void clock_init(void) {
  ...
  // divide things
  register_set(&(RCC->CFGR), RCC_CFGR_HPRE_DIV1 | RCC_CFGR_PPRE2_DIV2 | RCC_CFGR_PPRE1_DIV4, 0xFF7FFCF3U); //HPRE = AHB PREC = 1; PPRE2= APB2 PREC = 2; PPRE1= APB1 PREC = 4
  ...
  //PLLQ = 4; PLLM = 8; PLLN = 96; PLLSCR_HSE = HSE is SRC;
  ...
  // *** running on PLL ***
  //SYSCLK, AHBCLK, and CPU CLK all run at 96MHz
}
